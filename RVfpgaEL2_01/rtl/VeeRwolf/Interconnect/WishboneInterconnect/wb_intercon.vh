...
// ACCELERATOR
wire [31:0] wb_m2s_accelerator_adr;
wire [31:0] wb_m2s_accelerator_dat;
wire  [3:0] wb_m2s_accelerator_sel;
wire        wb_m2s_accelerator_we;
wire        wb_m2s_accelerator_cyc;
wire        wb_m2s_accelerator_stb;
wire  [2:0] wb_m2s_accelerator_cti;
wire  [1:0] wb_m2s_accelerator_bte;
wire [31:0] wb_s2m_accelerator_dat;
wire        wb_s2m_accelerator_ack;
wire        wb_s2m_accelerator_err;
wire        wb_s2m_accelerator_rty;
...
// SPI
    ...
    // ACCELERATOR	
    .wb_accelerator_adr_o      (wb_m2s_accelerator_adr),
    .wb_accelerator_dat_o      (wb_m2s_accelerator_dat),
    .wb_accelerator_sel_o      (wb_m2s_accelerator_sel),
    .wb_accelerator_we_o       (wb_m2s_accelerator_we),
    .wb_accelerator_cyc_o      (wb_m2s_accelerator_cyc),
    .wb_accelerator_stb_o      (wb_m2s_accelerator_stb),
    .wb_accelerator_cti_o      (wb_m2s_accelerator_cti),
    .wb_accelerator_bte_o      (wb_m2s_accelerator_bte),
    .wb_accelerator_dat_i      (wb_s2m_accelerator_dat),
    .wb_accelerator_ack_i      (wb_s2m_accelerator_ack),
    .wb_accelerator_err_i      (wb_s2m_accelerator_err),
    .wb_accelerator_rty_i      (wb_s2m_accelerator_rty)
	);