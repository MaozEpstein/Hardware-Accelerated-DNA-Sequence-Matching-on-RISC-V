...
module axi_intercon
   (input  wire        clk_i,
    ...
    //Alex Grinshpun input  wire  [3:0] i_lsu_awid,
    input  wire  [2:0] i_lsu_awid,
    ...
    //Alex Grinshpun input  wire  [3:0] i_lsu_arid,
    input  wire  [2:0] i_lsu_arid,//Alex Grinshpun
    ...
    //Alex Grinshpun output wire  [3:0] o_lsu_bid,
    output wire  [2:0] o_lsu_bid, //Alex Grinshpun
    output wire  [1:0] o_lsu_bresp,
    output wire        o_lsu_bvalid,
    input  wire        i_lsu_bready,
    //Alex Grinshpun output wire  [3:0] o_lsu_rid,
    output wire  [2:0] o_lsu_rid, //Alex Grinshpun
    ...
    //Alex Grinshpun
    output wire  [5:0] o_io_vga_awid,
    output wire [31:0] o_io_vga_awaddr,
    output wire  [7:0] o_io_vga_awlen,
    output wire  [2:0] o_io_vga_awsize,
    output wire  [1:0] o_io_vga_awburst,
    output wire        o_io_vga_awlock,
    output wire  [3:0] o_io_vga_awcache,
    output wire  [2:0] o_io_vga_awprot,
    output wire  [3:0] o_io_vga_awregion,
    output wire  [3:0] o_io_vga_awqos,
    output wire        o_io_vga_awvalid,
    input  wire        i_io_vga_awready,
    output wire  [5:0] o_io_vga_arid,
    output wire [31:0] o_io_vga_araddr,
    output wire  [7:0] o_io_vga_arlen,
    output wire  [2:0] o_io_vga_arsize,
    output wire  [1:0] o_io_vga_arburst,
    output wire        o_io_vga_arlock,
    output wire  [3:0] o_io_vga_arcache,
    output wire  [2:0] o_io_vga_arprot,
    output wire  [3:0] o_io_vga_arregion,
    output wire  [3:0] o_io_vga_arqos,
    output wire        o_io_vga_arvalid,
    input  wire        i_io_vga_arready,
    output wire [63:0] o_io_vga_wdata,
    output wire  [7:0] o_io_vga_wstrb,
    output wire        o_io_vga_wlast,
    output wire        o_io_vga_wvalid,
    input  wire        i_io_vga_wready,
    input  wire  [5:0] i_io_vga_bid,
    input  wire  [1:0] i_io_vga_bresp,
    input  wire        i_io_vga_bvalid,
    output wire        o_io_vga_bready,
    input  wire  [5:0] i_io_vga_rid,
    input  wire [63:0] i_io_vga_rdata,
    input  wire  [1:0] i_io_vga_rresp,
    input  wire        i_io_vga_rlast,
    input  wire        i_io_vga_rvalid,
    output wire        o_io_vga_rready
    );


  localparam int unsigned NoMasters   = 32'd3;    // How many Axi Masters there are
  localparam int unsigned NoSlaves    = 32'd3;    // How many Axi Slaves  there are //Alex Grinshpun
  ...
  localparam rule_t [2:0] AddrMap = '{ //Alex Grinshpun
    '{idx: 32'd0, start_addr: 32'h80000000, end_addr: 32'h80004000},
    '{idx: 32'd1, start_addr: 32'h00000000, end_addr: 32'h08000000},
    '{idx: 32'd2, start_addr: 32'h80004000, end_addr: 32'h80004100}};
   slv_req_t  [2:0] masters_req;
   slv_resp_t [2:0] masters_resp;
   mst_req_t  [2:0] slaves_req; //Alex Grinshpun
   mst_resp_t [2:0] slaves_resp; //Alex Grinshpun
   ...
   //Alex Grinshpun
     ...
     //Slave io
   assign o_io_vga_awid = slaves_req[2].aw.id;
   assign o_io_vga_awaddr = slaves_req[2].aw.addr;
   assign o_io_vga_awlen = slaves_req[2].aw.len;
   assign o_io_vga_awsize = slaves_req[2].aw.size;
   assign o_io_vga_awburst = slaves_req[2].aw.burst;
   assign o_io_vga_awlock = slaves_req[2].aw.lock;
   assign o_io_vga_awcache = slaves_req[2].aw.cache;
   assign o_io_vga_awprot = slaves_req[2].aw.prot;
   assign o_io_vga_awregion = slaves_req[2].aw.region;
   assign o_io_vga_awqos = slaves_req[2].aw.qos;
   assign o_io_vga_awvalid = slaves_req[2].aw_valid;
   assign slaves_resp[2].aw_ready = i_io_vga_awready;
   assign o_io_vga_arid = slaves_req[2].ar.id;
   assign o_io_vga_araddr = slaves_req[2].ar.addr;
   assign o_io_vga_arlen = slaves_req[2].ar.len;
   assign o_io_vga_arsize = slaves_req[2].ar.size;
   assign o_io_vga_arburst = slaves_req[2].ar.burst;
   assign o_io_vga_arlock = slaves_req[2].ar.lock;
   assign o_io_vga_arcache = slaves_req[2].ar.cache;
   assign o_io_vga_arprot = slaves_req[2].ar.prot;
   assign o_io_vga_arregion = slaves_req[2].ar.region;
   assign o_io_vga_arqos = slaves_req[2].ar.qos;
   assign o_io_vga_arvalid = slaves_req[2].ar_valid;
   assign slaves_resp[2].ar_ready = i_io_vga_arready;
   assign o_io_vga_wdata = slaves_req[2].w.data;
   assign o_io_vga_wstrb = slaves_req[2].w.strb;
   assign o_io_vga_wlast = slaves_req[2].w.last;
   assign o_io_vga_wvalid = slaves_req[2].w_valid;
   assign slaves_resp[2].w_ready = i_io_vga_wready;
   assign slaves_resp[2].b.id = i_io_vga_bid;
   assign slaves_resp[2].b.resp = i_io_vga_bresp;
   assign slaves_resp[2].b_valid = i_io_vga_bvalid;
   assign o_io_vga_bready = slaves_req[2].b_ready;
   assign slaves_resp[2].r.id = i_io_vga_rid;
   assign slaves_resp[2].r.data = i_io_vga_rdata;
   assign slaves_resp[2].r.resp = i_io_vga_rresp;
   assign slaves_resp[2].r.last = i_io_vga_rlast;
   assign slaves_resp[2].r_valid = i_io_vga_rvalid;
   assign o_io_vga_rready = slaves_req[2].r_ready;
