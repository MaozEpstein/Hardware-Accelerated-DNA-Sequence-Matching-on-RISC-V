...
`endif
    ...
    //Alex Grinshpun
    output wire  [5:0] o_vga_awid,
    output wire [31:0] o_vga_awaddr,
    output wire  [7:0] o_vga_awlen,
    output wire  [2:0] o_vga_awsize,
    output wire  [1:0] o_vga_awburst,
    output wire        o_vga_awlock,
    output wire  [3:0] o_vga_awcache,
    output wire  [2:0] o_vga_awprot,
    output wire  [3:0] o_vga_awregion,
    output wire  [3:0] o_vga_awqos,
    output wire        o_vga_awvalid,
    input  wire        i_vga_awready,
    output wire  [5:0] o_vga_arid,
    output wire [31:0] o_vga_araddr,
    output wire  [7:0] o_vga_arlen,
    output wire  [2:0] o_vga_arsize,
    output wire  [1:0] o_vga_arburst,
    output wire        o_vga_arlock,
    output wire  [3:0] o_vga_arcache,
    output wire  [2:0] o_vga_arprot,
    output wire  [3:0] o_vga_arregion,
    output wire  [3:0] o_vga_arqos,
    output wire        o_vga_arvalid,
    input  wire        i_vga_arready,
    output wire [63:0] o_vga_wdata,
    output wire  [7:0] o_vga_wstrb,
    output wire        o_vga_wlast,
    output wire        o_vga_wvalid,
    input  wire        i_vga_wready,
    input  wire  [5:0] i_vga_bid,
    input  wire  [1:0] i_vga_bresp,
    input  wire        i_vga_bvalid,
    output wire        o_vga_bready,
    input  wire  [5:0] i_vga_rid,
    input  wire [63:0] i_vga_rdata,
    input  wire  [1:0] i_vga_rresp,
    input  wire        i_vga_rlast,
...
`include "axi_intercon.vh"
   ...
   assign o_ram_rready   = ram_rready;
     ...
     //Alex Grinshpun
	assign o_vga_awid		= vga_awid;
	assign o_vga_awaddr		= vga_awaddr;
	assign o_vga_awlen		= vga_awlen;
	assign o_vga_awsize		= vga_awsize;
	assign o_vga_awburst	= vga_awburst;
	assign o_vga_awlock		= vga_awlock;
	assign o_vga_awcache	= vga_awcache;
	assign o_vga_awprot		= vga_awprot;
	assign o_vga_awregion	= vga_awregion;
	assign o_vga_awqos		= vga_awqos;
	assign o_vga_awvalid	= vga_awvalid;
	//assign o_vga_awready	= i_vga_awready;
	assign o_vga_arid		= vga_arid;
	assign o_vga_araddr		= vga_araddr;
	assign o_vga_arlen		= vga_arlen;
	assign o_vga_arsize		= vga_arsize;
	assign o_vga_arburst	= vga_arburst;
	assign o_vga_arlock		= vga_arlock;
	assign o_vga_arcache	= vga_arcache;
	assign o_vga_arprot		= vga_arprot;
	assign o_vga_arregion	= vga_arregion;
	assign o_vga_arqos		= vga_arqos;
	assign o_vga_arvalid	= vga_arvalid;
	//assign vga_arready		= i_vga_arready;
	assign o_vga_wdata		= vga_wdata;
	assign o_vga_wstrb		= vga_wstrb;
	assign o_vga_wlast		= vga_wlast;
	assign o_vga_wvalid		= vga_wvalid;
	assign vga_wready		= i_vga_wready;
	assign vga_bid			= i_vga_bid;
	assign vga_bresp		= i_vga_bresp;
	assign vga_bvalid		= i_vga_bvalid;
	assign o_vga_bready		= vga_bready;
	assign vga_rid			= i_vga_rid;
	assign vga_rdata		= i_vga_rdata;
	assign vga_rresp		= i_vga_rresp;
	assign vga_rlast		= i_vga_rlast;
	assign vga_rvalid		= i_vga_rvalid;
	assign o_vga_rready		= vga_rready;
...
`endif
  ...
  `else
        ...
        //Alex Grinshpun.ext_pad_i     (i_gpio[31:0]),
        //Alex Grinshpun.ext_pad_o     (o_gpio[31:0]),
  `ifdef XSIM  //Alex Grinshpun
        .ext_pad_i     ({i_sw,i_gpio[15:0]}),
  `else
...
accelerator_top accelerator_top	(
		...
		.wb_clk_i	(clk),
		.wb_rst_i	(~rst_n),
		.wb_adr_i	({21'h0,wb_m2s_accelerator_adr[10:0]}),
		.wb_dat_i	(wb_m2s_accelerator_dat),
		.wb_we_i	(wb_m2s_accelerator_we),
		.wb_cyc_i	(wb_m2s_accelerator_cyc),
		.wb_stb_i	(wb_m2s_accelerator_stb),
		.wb_sel_i	(4'hF), // Not used in 8-bit mode
		.wb_dat_o	(wb_s2m_accelerator_dat),
		.wb_ack_o	(wb_s2m_accelerator_ack),
...
`endif
      ...
      .timer_int (timer_irq),
      .extintsrc_req ({27'd0, sw_irq4, sw_irq3, spi0_irq, uart_irq}), //Alex Grinshpun
