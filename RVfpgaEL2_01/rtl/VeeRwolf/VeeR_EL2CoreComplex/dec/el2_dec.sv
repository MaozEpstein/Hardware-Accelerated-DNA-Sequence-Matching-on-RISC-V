...
`endif
   ...
   logic [31:0]  pc;
   assign pc = dec_i0_pc_d*2; //Alex Grinshpun


   el2_dec_ib_ctl /* Alex Grinshpun #(.pt(pt)) */ instbuff (.*);


   el2_dec_decode_ctl /* Alex Grinshpun #(.pt(pt)) */ decode (.*);


   el2_dec_tlu_ctl /* Alex Grinshpun #(.pt(pt)) */ tlu (.*);


   el2_dec_gpr_ctl /*Alex Grinshpun #(.pt(pt))*/ arf (.*,
                    // inputs
...
// Trigger
   ...
   el2_dec_trigger /*Alex Grinshpun #(.pt(pt)) */  dec_trigger (.*);
