...
import el2_pkg::*;
#(
//Alex Grinshpun `include "el2_param.vh"
 )
(
...
`endif
   ...
   el2_lsu_lsc_ctl /* Alex Grinshpun #(.pt(pt)) */lsu_lsc_ctl (.*);
   ...
   el2_lsu_dccm_ctl /* Alex Grinshpun #(.pt(pt)) */ dccm_ctl (
   ...
   el2_lsu_stbuf /* Alex Grinshpun #(.pt(pt)) */ stbuf (
   ...
   el2_lsu_ecc /*Alex Grinshpun  #(.pt(pt))*/ ecc (
   ...
   el2_lsu_trigger /* Alex Grinshpun #(.pt(pt)) */ trigger (
      .store_data_m(store_data_m[31:0]),
      .*
   );

   // Clk domain
   el2_lsu_clkdomain /* Alex Grinshpun#(.pt(pt)) */ clkdomain (.*);

   // Bus interface
   el2_lsu_bus_intf /* Alex Grinshpun#(.pt(pt)) */ bus_intf (
